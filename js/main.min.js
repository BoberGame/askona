...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nconst changeIconColor = () => {\r\n  document.addEventListener('click', (e) => {\r\n    const btn = e.target.closest('.product-card__mobileButtons-button');\r\n    if (btn) {\r\n      btn.classList.toggle('active');\r\n    }\r\n  });\r\n};\r\nchangeIconColor();\n\n//# sourceURL=webpack://gulp-2022/./app/js/components/card.js?");

/***/ }),

/***/ "./app/js/components/cart.js":
/*!***********************************!*\
  !*** ./app/js/components/cart.js ***!
  \***********************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var tom_select__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tom-select */ \"./node_modules/tom-select/dist/js/tom-select.complete.js\");\n\r\n\r\ndocument.querySelectorAll('.select').forEach((el) => {\r\n  let settings = {\r\n    create: false,\r\n    controlInput: null,\r\n    allowEmptyOption: true,\r\n  };\r\n  if (el) {\r\n    new tom_select__WEBPACK_IMPORTED_MODULE_0__(el, settings);\r\n  }\r\n});\r\n\n\n//# sourceURL=webpack://gulp-2022/./app/js/components/select.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @splidejs/splide */ \"./node_modules/@splidejs/splide/dist/js/splide.esm.js\");\n/* harmony import */ var _components_header_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/header.js */ \"./app/js/components/header.js\");\n/* harmony import */ var _components_popup_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/popup.js */ \"./app/js/components/popup.js\");\n/* harmony import */ var _components_accordion_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/accordion.js */ \"./app/js/components/accordion.js\");\n/* harmony import */ var _components_card_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/card.js */ \"./app/js/components/card.js\");\n/* harmony import */ var _components_form_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/form.js */ \"./app/js/components/form.js\");\n/* harmony import */ var _components_range_sldier_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/range-sldier.js */ \"./app/js/components/range-sldier.js\");\n/* harmony import */ var _components_select_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/select.js */ \"./app/js/components/select.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\ntry {\r\n  new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('#sale-slider', {\r\n    perPage: 3,\r\n    perMove: 1,\r\n    type: 'loop',\r\n    padding: '4.9%',\r\n    gap: '32px',\r\n    arrows: false,\r\n    flickPower: 100,\r\n    flickMaxPages: 1,\r\n    breakpoints: {\r\n      1440: {\r\n        padding: '1.2%',\r\n      },\r\n      1200: {\r\n        perPage: 3,\r\n        gap: '16px',\r\n        padding: '1.5%',\r\n      },\r\n      900: {\r\n        padding: '2%',\r\n      },\r\n      768: {\r\n        perPage: 2,\r\n      },\r\n      580: {\r\n        perPage: 1,\r\n        gap: '10px',\r\n        padding: '3.7%',\r\n      },\r\n      425: {\r\n        padding: '4.2%',\r\n      },\r\n    },\r\n  }).mount();\r\n} catch (error) {}\r\n\r\ntry {\r\n  new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('#cart-more-slider', {\r\n    perPage: 2,\r\n    perMove: 1,\r\n    type: 'loop',\r\n    gap: '32px',\r\n    arrows: true,\r\n    flickPower: 100,\r\n    flickMaxPages: 1,\r\n  }).mount();\r\n} catch (error) {}\r\n\r\ntry {\r\n  new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('#info-slider', {\r\n    perPage: 1,\r\n    perMove: 1,\r\n    type: 'loop',\r\n    gap: '32px',\r\n    flickPower: 100,\r\n    flickMaxPages: 1,\r\n    mediaQuery: 'min',\r\n    arrows: false,\r\n    breakpoints: {\r\n      902: {\r\n        perPage: 3,\r\n        type: 'slide',\r\n        drag: false,\r\n        gap: 0,\r\n        pagination: false,\r\n      },\r\n    },\r\n  }).mount();\r\n} catch (error) {}\r\n\r\ntry {\r\n  new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('#category-slider', {\r\n    perPage: 2,\r\n    perMove: 1,\r\n    type: 'loop',\r\n    gap: '0px',\r\n    arrows: true,\r\n    flickPower: 100,\r\n    flickMaxPages: 1,\r\n    breakpoints: {\r\n      1200: {\r\n        perPage: 1.5,\r\n      },\r\n      1024: {\r\n        perPage: 1,\r\n      },\r\n    },\r\n  }).mount();\r\n} catch (error) {}\r\n\r\ntry {\r\n  const catalogSlider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('#catalog-slider', {\r\n    perPage: 12,\r\n    perMove: 1,\r\n    type: 'loop',\r\n    gap: '32px',\r\n    arrows: true,\r\n    flickPower: 100,\r\n    flickMaxPages: 1,\r\n    breakpoints: {\r\n      1440: {\r\n        arrows: false,\r\n        perPage: 10,\r\n      },\r\n      1200: {\r\n        perPage: 9,\r\n      },\r\n      1024: {\r\n        perPage: 7.5,\r\n      },\r\n      768: {\r\n        perPage: 4.5,\r\n        pagination: false,\r\n        speed: 50,\r\n        flickPower: 50,\r\n      },\r\n      620: {\r\n        perPage: 3.5,\r\n      },\r\n      520: {\r\n        perPage: 3,\r\n      },\r\n      425: {\r\n        perPage: 2.5,\r\n      },\r\n    },\r\n  });\r\n\r\n  const bar = document.querySelector('.catalog-slider-progress-bar');\r\n  catalogSlider.on('move', () => {\r\n    const end = catalogSlider.Components.Controller.getEnd() + 1;\r\n    const slide = catalogSlider.Components.Slides.getAt(\r\n      catalogSlider.index,\r\n    ).slide;\r\n    const rate = Math.min((catalogSlider.index + 1) / end, 1);\r\n    bar.style.transform = `translateX(${100 * rate}%)`;\r\n    bar.style.width = slide.offsetWidth + 'px';\r\n  });\r\n  catalogSlider.mount();\r\n} catch (error) {}\r\n\r\nfor (let i = 1; i <= 2; i++) {\r\n  try {\r\n    new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__[\"default\"](`#product-slider-${i}`, {\r\n      perPage: 4,\r\n      perMove: 1,\r\n      type: 'loop',\r\n      gap: '32px',\r\n      arrows: true,\r\n      flickPower: 100,\r\n      flickMaxPages: 1,\r\n      breakpoints: {\r\n        1440: {\r\n          perPage: 3,\r\n          arrows: false,\r\n        },\r\n        900: {\r\n          perPage: 2,\r\n        },\r\n        580: {\r\n          perPage: 2,\r\n        },\r\n      },\r\n    }).mount();\r\n  } catch (error) {}\r\n}\r\n\r\nconst slideForHover = (sliderElem, slider) => {\r\n  const paginationElems = sliderElem.querySelectorAll(\r\n    '.splide__pagination__page',\r\n  );\r\n  paginationElems.forEach((bullet) => {\r\n    bullet.addEventListener('mouseenter', () => {\r\n      const slideIndex = bullet.getAttribute('aria-label').replace(/^\\D+/g, '');\r\n      const slide = parseInt(slideIndex - 1, 10);\r\n      slider.go(slide);\r\n    });\r\n  });\r\n};\r\n\r\n/* Gallery slider */\r\nconst galleryItems = document.querySelectorAll('.splide__gallery');\r\nfor (let index = 0; index < galleryItems.length; index++) {\r\n  const element = galleryItems[index];\r\n  element.id = `product-gallery-${index}`;\r\n  if (element !== null) {\r\n    const slider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__[\"default\"](`#product-gallery-${index}`, {\r\n      type: 'slide',\r\n      pagination: true,\r\n      arrows: false,\r\n      gap: 0,\r\n      drag: false,\r\n      breakpoints: {\r\n        768: {\r\n          pagination: false,\r\n        },\r\n      },\r\n    });\r\n    slider.mount();\r\n    const slidesLen = slider.length;\r\n\r\n    if (slidesLen > 1) {\r\n      if (window.matchMedia('(min-width: 728px)').matches) {\r\n        slideForHover(element, slider);\r\n      }\r\n    }\r\n  }\r\n}\r\n\r\nfor (let i = 1; i <= 2; i++) {\r\n  try {\r\n    new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__[\"default\"](`#benefits-slider-${i}`, {\r\n      perPage: 1,\r\n      perMove: 1,\r\n      type: 'loop',\r\n      gap: '32px',\r\n      arrows: false,\r\n      flickPower: 100,\r\n      flickMaxPages: 1,\r\n    }).mount();\r\n  } catch (error) {}\r\n}\r\n\r\nwindow.addEventListener('scroll', (e) => {\r\n  if (window.pageYOffset > 1000) {\r\n    document.querySelector('.scroll-top').classList.add('active');\r\n  } else {\r\n    document.querySelector('.scroll-top').classList.remove('active');\r\n  }\r\n});\r\n\n\n//# sourceURL=webpack://gulp-2022/./app/js/main.js?");
